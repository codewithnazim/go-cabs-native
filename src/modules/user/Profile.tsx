    ...
    return (
        <>
            <View style={styles.container}>
                <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center', justifyContent: 'space-between', marginBottom: 2 }}>
                    <View>
                ...
                {userType === "Driver" ?
                    ...
                    <>
                        <Margin margin={20} />
                        <CustomButton title="Safety Check"
                ...
                <View style={{ gap: 20 }}>
                    {profileListItems?.map((item, i) =>
                        <TouchableOpacity key={i} style={styles.listitem}
                            onPress={() => navigation.navigate('ProfileScreens', { screen: item.path })}
                        >
                            <Icon name={item?.icon} fill={primaryColor} width={25} height={25} />
