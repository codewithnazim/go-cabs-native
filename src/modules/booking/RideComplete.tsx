        ...
        <>
            <View style={styles.container}>
                <View style={styles.topBlock}>
                    <View style={{ width: '100%', height: 150, backgroundColor: backgroundPrimary }}>
                        <WebView
                            originWhitelist={['*']}
                ...
                <ScrollView style={styles.middleBlock}>
                    ...
                    <View style={{ padding: 20 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20 }}>
                            <Text style={[styles.h5, { color: primaryColor, fontFamily: 'Montserrat-SemiBold' }]}>
                        ...
                        <Margin margin={40} />
                        <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center', paddingLeft: 20, marginBottom: -10 }}>
                            <Text style={[styles.h5, { fontFamily: 'Montserrat-SemiBold', marginTop: 1 }]}>
                                How was your experience?
                            </Text>
                            <View style={{ flexDirection: 'row', gap: 4, alignItems: 'center' }}>
                                <Icon name="star-outline" width={15} height={15} fill={"#fff"} />
                                <Icon name="star-outline" width={15} height={15} fill={"#fff"} />
                                <Icon name="star-outline" width={15} height={15} fill={"#fff"} />
                                <Icon name="star-outline" width={15} height={15} fill={"#fff"} />
                                <Icon name="star-outline" width={15} height={15} fill={"#fff"} />
