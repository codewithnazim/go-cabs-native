        ...
        <>
            <View style={styles.container}>
                <View style={styles.topBlock}>
                    <View style={{ width: '100%', height: startRide ? 320 : 250, backgroundColor: backgroundPrimary }}>
                        <WebView
                            originWhitelist={['*']}
                ...
                <ScrollView style={styles.middleBlock}>
                    <View style={{ padding: 20 }}>
                        ...
                        <View style={styles.innerCard}>
                            <View style={{
                                flexDirection: 'row', justifyContent: "space-between", paddingVertical: 10, paddingHorizontal: 20,
                                borderBottomWidth: 1.5,
                                borderBottomColor: '#FFFFFF33'
                            }}>
                                <Text style={[styles.h5, { fontFamily: 'Montserrat-SemiBold' }]}>Distance to Pickup</Text>
                                <Text style={[styles.h5, { color: primaryColor, fontFamily: 'Montserrat-SemiBold' }]}>800 m</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: "space-between", paddingVertical: 10, paddingHorizontal: 20, }}>
                                <Text style={[styles.h5, { fontFamily: 'Montserrat-SemiBold' }]}>Estimated Time</Text>
                                <Text style={[styles.h5, { color: primaryColor, fontFamily: 'Montserrat-SemiBold' }]}>2 min</Text>
                            </View>
                        </View>
                        <Margin margin={40} />
                        ...
                        <View style={{ flexDirection: 'row', gap: 50, alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20 }}>
